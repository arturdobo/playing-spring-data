...
public class Base {
	...
	public static void beforeClass() {
		...
		comp1 = new Company("Comp1", null, Collections.singletonList(person1));
		comp2 = new Company("Comp2", null, Arrays.asList(person2, person3));
		comp3 = new Company("Comp3", null, Collections.singletonList(person4));
	}
